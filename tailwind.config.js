	...
	theme: {
		extend: {
			...
			colors: {
				sky: {
					'400': '#38bdf8',
					'500': '#0189d0', // User Primary Blue
					'600': '#016fa7', // Darker for hover
				},
				// Mapping generic color names to User's specific palette for consistency
				green: {
					'500': '#07b24a', // User Success Green
					'600': '#058f3b',
					'400': '#4ade80', // Keep defaults or adjust? Keeping default to avoid breakage, but maybe adjust if needed.
				},
				red: {
					'500': '#cc004c', // User Danger Red
					'600': '#a3003d',
				},
				amber: {
					'50': '#fffbeb',
					'300': '#fcd34d',
					'400': '#fbb712', // User Yellow (mapped to amber-400 similar to before)
					'500': '#f37021', // User Orange? No, keep logic separate.
				},
				yellow: {
			...
			keyframes: {
				...
				glow: { '0%, 100%': { boxShadow: '0 0 20px -5px rgba(99, 102, 241, 0.4)' }, '50%': { boxShadow: '0 0 40px -5px rgba(99, 102, 241, 0.6)' } },
