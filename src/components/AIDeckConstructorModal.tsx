    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent hideClose className="sm:max-w-md w-full h-[95vh] sm:h-auto sm:max-h-[90vh] bg-amber-50 dark:bg-slate-900 rounded-t-3xl sm:rounded-3xl p-6 sm:p-8 flex flex-col overflow-hidden border-0 dark:border-0 shadow-2xl">
                ...
                <ScrollArea className="flex-1 w-full mt-4 pr-2">
                    <div className="space-y-4 py-2">
                        <textarea
                            className="w-full h-64 p-4 text-sm font-sans bg-white/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none resize-none transition-all text-slate-700 dark:text-slate-300"
                            value={prompt}
                        ...
                        <div className="flex flex-wrap gap-2 pt-2 pb-4">
                            <Button
                                ...
                                className="bg-[#10a37f] hover:bg-[#10a37f]/90 text-white font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
                            ...
                            <Button
                                ...
                                className="bg-[#111827] hover:bg-[#111827]/90 text-white font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
                                {t('aiModal.llms.claude')}
                            </Button>
                            <Button
                                onClick={() => openLLM('https://grok.com/?q=')}
                                className="bg-[#ffb100] hover:bg-[#ffb100]/90 text-black font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
                                {t('aiModal.llms.grok')}
                            </Button>
                            <Button
                                onClick={() => openLLM('https://perplexity.ai/search/new?q=')}
                                className="bg-[#4a90e2] hover:bg-[#4a90e2]/90 text-white font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
                                {t('aiModal.llms.perplexity')}
                            </Button>
                            <Button
                                onClick={() => openLLM('https://chat.mistral.ai/chat?q=')}
                                className="bg-[#9a4dff] hover:bg-[#9a4dff]/90 text-white font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
                                {t('aiModal.llms.mistral')}
                            </Button>
                            <Button
                                onClick={() => copyAndOpen('https://copilot.microsoft.com/')}
                                className="bg-[#0078d4] hover:bg-[#0078d4]/90 text-white font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
                                {t('aiModal.llms.copilot')}
                            </Button>
                            <Button
                                onClick={() => copyAndOpen('https://chat.deepseek.com')}
                                className="bg-[#333333] hover:bg-[#333333]/90 text-white font-bold rounded-lg px-4 py-2 h-10 transition-transform duration-200 hover:scale-105 active:scale-95"
                            >
