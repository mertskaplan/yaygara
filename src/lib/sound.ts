...
class SoundManager {
    ...
    playCorrect() {
        ...
        // Ascending chime
        this.createOscillator('triangle', 523.25, now, 0.3, 0.1); // C5
        this.createOscillator('triangle', 659.25, now + 0.1, 0.3, 0.1); // E5
        this.createOscillator('triangle', 783.99, now + 0.2, 0.4, 0.1); // G5
    }
    ...
    playPass() {
        ...
        const now = this.audioCtx.currentTime;
        // Descending "boop"
        this.createOscillator('sine', 440, now, 0.2, 0.1); // A4
        this.createOscillator('sine', 349.23, now + 0.1, 0.3, 0.08); // F4
    }
    ...
    playTick() {
        ...
        const now = this.audioCtx.currentTime;
        // Short sharp pulse
        this.createOscillator('square', 880, now, 0.05, 0.03); // A5
    }
    ...
    playTimeUp() {
        ...
        notes.forEach((freq, i) => {
            this.createOscillator('triangle', freq, now + i * 0.08, 0.4, 0.08);
        });
    }
    ...
    playGameOver() {
        ...
        melody.forEach((note) => {
            this.createOscillator('triangle', note.freq, now + note.time, note.dur, 0.1);
        });
    }
    ...
    playUndo() {
        ...
        this.createOscillator('sine', 330, now, 0.2, 0.08); // E4
        this.createOscillator('sine', 440, now + 0.05, 0.1, 0.05); // A4
    }
    ...
    playPop() {
        ...
        this.createOscillator('sine', 1200, now, 0.05, 0.05);
    }
}
